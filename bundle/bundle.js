...
const Arc = ({ progress, rotation, rotateProgress }) => {
  const { width, height } = (0,dist.useVideoConfig)();
  const [gradientId] = (0,react.useState)(() => String((0,dist.random)(null)));
...
const Atom = ({ scale }) => {
  const config = (0,dist.useVideoConfig)();
  const [gradientId] = (0,react.useState)(() => String((0,dist.random)(null)));
  return /* @__PURE__ */ React.createElement("svg", {
...
const Logo = () => {
  ...
  const development = (0,dist.spring)({
    config: {
      damping: 100,
      mass: 0.5
    },
  ...
  const rotationDevelopment = (0,dist.spring)({
    config: {
      damping: 100,
      mass: 0.5
    },
  ...
  const logoRotation = (0,dist.interpolate)(frame, [0, videoConfig.durationInFrames], [0, 360]);
...
const Subtitle = () => {
  const frame = (0,dist.useCurrentFrame)();
  const opacity = (0,dist.interpolate)(frame, [0, 30], [0, 1]);
  return /* @__PURE__ */ react.createElement("div", {
    style: __spreadProps(__spreadValues({}, subtitle), { opacity })
  }, "Edit ", /* @__PURE__ */ react.createElement("code", {
    style: codeStyle
  }, "src/Video.tsx"), " and save to reload.");
};

;// CONCATENATED MODULE: ./src/HelloWorld/Title.tsx
var Title_defProp = Object.defineProperty;
var Title_defProps = Object.defineProperties;
var Title_getOwnPropDescs = Object.getOwnPropertyDescriptors;
...
var Title_spreadProps = (a, b) => Title_defProps(a, Title_getOwnPropDescs(b));
...
const Title = ({ titleText, titleColor }) => {
  ...
  return /* @__PURE__ */ react.createElement("h1", {
    ...
    return /* @__PURE__ */ react.createElement("span", {
      key: t,
      style: Title_spreadProps(Title_spreadValues({}, word), {
        color: titleColor,
        transform: `scale(${scale})`
      })
    }, t);
...
const HelloWorld = ({ titleText, titleColor }) => {
  const frame = (0,dist.useCurrentFrame)();
  const { durationInFrames, fps } = (0,dist.useVideoConfig)();
  const logoTranslationProgress = (0,dist.spring)({
    frame: frame - 25,
    fps,
    config: {
      damping: 100
  ...
  const logoTranslation = (0,dist.interpolate)(logoTranslationProgress, [0, 1], [0, -150]);
  const opacity = (0,dist.interpolate)(frame, [durationInFrames - 25, durationInFrames - 15], [1, 0], {
  ...
  }, /* @__PURE__ */ React.createElement(Logo, null)), /* @__PURE__ */ React.createElement(dist.Sequence, {
    from: 35
  }, /* @__PURE__ */ React.createElement(Title, {
    titleText,
    titleColor
  })), /* @__PURE__ */ React.createElement(dist.Sequence, {
    from: 75
  }, /* @__PURE__ */ React.createElement(Subtitle, null))));
};
...
const RemotionVideo = () => {
  ...
  }), /* @__PURE__ */ React.createElement(dist.Composition, {
    id: "OnlyLogo",
    component: Logo,
    durationInFrames: 150,
    fps: 30,
